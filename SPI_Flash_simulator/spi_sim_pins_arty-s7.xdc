...
## Buttons
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { push_button }]; #IO_L18N_T2_A23_15 Sch=btn[0]
...
## USB-UART Interface
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { tx_out }]; #IO_25_14 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { rx_in }]; #IO_L24N_T3_A00_D16_14 Sch=uart_txd_in
## ChipKit Outer Digital Header
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { trigger_out }]; #IO_0_14 Sch=ck_io[0]
set_property -dict { PACKAGE_PIN N13   IOSTANDARD LVCMOS33 } [get_ports { rst_btn }]; #IO_L6N_T0_D08_VREF_14   Sch=ck_io[1]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { spi_reset }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=ck_io[2]
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { reset_out }]; #IO_L13P_T2_MRCC_14      Sch=ck_io[3]
...
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { comp_clk }]; #IO_L17P_T2_A14_D30_14   Sch=ck_io[8]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { tru_clk }]; #IO_L17N_T2_A13_D29_14   Sch=ck_io[9]
...
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { spi_cs   }]; #IO_L22P_T3_A17_15   Sch=ck_io10_ss
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { spi_sio0 }]; #IO_L22N_T3_A16_15   Sch=ck_io11_mosi
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { spi_sio1 }]; #IO_L23P_T3_FOE_B_15 Sch=ck_io12_miso
set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { spi_clk  }]; #IO_L14P_T2_SRCC_15  Sch=ck_io13_sck
